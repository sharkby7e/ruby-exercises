...
RSpec.describe 'Advanced Nested Collections' do
  ...
  it 'test 6' do
    ...
    dishes_names = stores[:olive_garden][:dishes].map { |d| d[:name] }
  ...
  it 'test 7' do
    ...
    # all restaurants
    employee_names = []
    stores.each { |_, info| employee_names += info[:employees] }
  ...
  it 'test 8' do
    ...
    ingredients = []
    stores.each { |_, info| info[:dishes].each { |dish| ingredients += dish[:ingredients] } }
  ...
  it 'test 10' do
    ...
    olive_garden_menu = stores[:olive_garden][:dishes].each_with_object({}) do |dish, acc|
      acc[dish[:name]] = dish
    end
  ...
  it 'test 11' do
    ...
    full_menu = stores.each_value.with_object({}) do |info, acc|
